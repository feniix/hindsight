...
async def _run_reflect_agent_inner(
    ...
    *,
    ...
    for iteration in range(max_iterations):
        ...
        # Fresh, nonempty mental models do not establish coverage of the query.
        # Previously low/mid budgets released this sequence early on freshness alone,
        # allowing false "nothing in the bank" answers without checking raw facts (#4567).
        ...
        next_is_auto = next_iter >= len(forced_sequence)
